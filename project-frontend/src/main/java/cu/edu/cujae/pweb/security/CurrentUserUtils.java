...
public class CurrentUserUtils {
	...
	public static String getUsername() {
		...
		if (SecurityContextHolder.getContext().getAuthentication() != null) {
			username = ((UserPrincipal) SecurityContextHolder.getContext().getAuthentication().getPrincipal())
					.getUsername();
		}
		return username;
	}
	...
	public static String getFullName() {
		...
		if (isLogged()) {
			fullName = ((UserPrincipal) SecurityContextHolder.getContext().getAuthentication().getPrincipal())
					.getFullName();
		}
		return fullName;
	}
	...
	public static String getUserId() {
		String userId = null;
		if (isLogged()) {
			userId = ((UserPrincipal) SecurityContextHolder.getContext().getAuthentication().getPrincipal())
					.getUserId();
		}
		return userId;
	}
	...
	public static boolean isLogged() {
		...
		if ((SecurityContextHolder.getContext().getAuthentication() != null)
				&& (!getUsername().equals(ANONYMOUS_USER))) {
